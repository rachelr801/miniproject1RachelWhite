...
## AI Usage
I used Claude to do the initial push to GitHub because I wasn't sure how to accomplish that within Claude Code.
...
If you the program prints PRACTICE_API_TOKEN is not set, then you will need to set it again in that window and re-run.
